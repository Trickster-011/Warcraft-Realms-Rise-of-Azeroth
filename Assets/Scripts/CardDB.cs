...
public class CardDB : MonoBehaviour
{
    ...
    void Awake()
    {
        cardList.Add(new Card("Lich King", "El rey de la plaga, capaz de congelar a un enemigo por turno reduciendo su poder a la mitdad", Resources.Load<Sprite>("The_Lich_King_TCG"), "H", 0, 0, 0));
